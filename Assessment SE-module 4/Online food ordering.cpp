...
int main()
{
	char name[30], pizza1[]="veggie pizza" ,pizza2[]="cheesy pizza" ,pizza3[]="Peri Peri" ,pizza4[]="Creamy Max", roll1[]="Cheese Roll", roll2[]="Mayo Roll", roll3[]="Veg Roll With Fries",bur1[]="Zinger Burger",bur2[]="veg Burger",bur3[]="cheese Burger";
	char sand1[]="Club Sandwich", sand2[]="Veg Crispy Sandwich", sand3[]="Extream Veg Sandwich";
	char bir1[]="Veg Biryani", bir2[]="kaju Biryani", bir3[]="hydrabadi Biryani",gotostart ;
